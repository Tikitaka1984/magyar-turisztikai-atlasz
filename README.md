...
a hibás adatot. Ha egy cache-ből visszaadott kép-URL már nem működik, az
alkalmazás érvényteleníti az adott cache-bejegyzést, majd újraindítja a
Wikipédia / Commons fallback-láncot. Privát mód, tiltott storage vagy quota hiba
...
helyes/hibás visszajelzést, a helyes választ és rövid magyarázatot jelenít meg.
